    ...
    ! function(a) {
        ...
        l.VERSION = "1.12.4", l.DEFAULTS = {
            ...
            init: function() {
                ...
                })), this.checkDisabled(), this.clickListener(), !0 === this.options.lazyLoadLiElements && this.$button.one("click.dropdown.data-api", function(a) {
                    b.$lis = null, b.liObj = {}, b.reloadLi(), b.render(), b.checkDisabled(), b.liHeight(!0), b.setStyle(), b.setWidth()
            ...
            createDropdown: function() {
                var b = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    i = '<div class="btn-group bootstrap-select' + b + c + '"><button type="button" class="' + this.options.styleBase + ' dropdown-toggle" data-toggle="dropdown"' + d + ' role="button" aria-labelledby="' + this.$element.attr("aria-labelledby") + '"><span class="filter-option pull-left"></span>&nbsp;<span class="bs-caret">' + this.options.template.caret + '</span></button><div class="dropdown-menu open" role="combobox">' + e + f + g + '<ul class="dropdown-menu inner" role="listbox" aria-expanded="false"></ul>' + h + "</div></div>";
                return a(i)
            },
            createView: function() {
            ...
            createLi: function() {
                ...
                return this.multiple || 0 !== this.$element.find("option:selected").length || this.options.title || this.$element.find("option").eq(0).prop("selected", !0).attr("selected", "selected"), d.join("")
            },
            findLis: function() {
            ...
            render: function(b) {
                ...
                !1 === b || this.options.initInProcess && !0 === this.options.lazyLoadLiElements || e.each(function(a) {
                    var b = d.findLis().eq(d.liObj[a]);
                    d.setDisabled(a, this.disabled || "OPTGROUP" === this.parentNode.tagName && this.parentNode.disabled, b), d.setSelected(a, this.selected, b)
                }), this.togglePlaceholder(), this.tabIndex();
                var f = function(b) {
                        if (!d.options.hideDisabled || !(b.disabled || "OPTGROUP" === b.parentNode.tagName && b.parentNode.disabled)) {
                            var c, e = a(b),
                                f = e.data("icon") && d.options.showIcon ? '<i class="' + d.options.iconBase + " " + e.data("icon") + '"></i> ' : "";
                            return c = d.options.showSubtext && e.data("subtext") && !d.multiple ? ' <small class="text-muted">' + e.data("subtext") + "</small>" : "", void 0 !== e.attr("title") ? e.attr("title") : e.data("content") && d.options.showContent ? e.data("content").toString() : f + e.html() + c
                        }
                    },
                    g = this.multiple || !0 !== this.options.singleSelectPerfTweak ? e.map(function() {
                        if (this.selected) return f(this)
                    }).toArray() : [f(this.$element[0][this.$element[0].selectedIndex])],
                    h = this.multiple ? g.join(this.options.multipleSeparator) : g[0];
                if (this.multiple && this.options.selectedTextFormat.indexOf("count") > -1) {
                    var i = this.options.selectedTextFormat.split(">");
                    if (i.length > 1 && g.length > i[1] || 1 == i.length && g.length >= 2) {
                        c = this.options.hideDisabled ? ", [disabled]" : "";
                        var j = e.not('[data-divider="true"], [data-hidden="true"]' + c).length;
                        h = ("function" == typeof this.options.countSelectedText ? this.options.countSelectedText(g.length, j) : this.options.countSelectedText).replace("{0}", g.length.toString()).replace("{1}", j.toString())
                    }
                }
                void 0 == this.options.title && (this.options.title = this.$element.attr("title")), "static" == this.options.selectedTextFormat && (h = this.options.title), h || (h = void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText), this.$button.attr("title", k(a.trim(h.replace(/<[^>]*>?/g, "")))), this.$button.children(".filter-option").html(h), this.options.initInProcess && !0 === this.options.lazyLoadLiElements || this.$element.trigger("rendered.bs.select")
            },
